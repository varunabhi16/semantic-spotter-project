...
- Clone the github repository
  ```shell
  $ git clone https://github.com/varunabhi16/semantic-spotter-project.git
  ```
- Open
  the [notebook](https://github.com/varunabhi16/semantic-spotter-project/blob/main/semantic-spotter-langchain-notebook.ipynb)
